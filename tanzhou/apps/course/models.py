...
class CourseClass(models.Model):
    name = models.CharField(choices = (('it',u"IT互联网"),('language',u"语言留学"),('design',u"创意设计"),('life',u'兴趣生活'),('plant',u"生产种植"),('edu',u'升学考研'),('certificate',u'公培考证')),max_length=15,verbose_name=u'分类')
...
class Course(models.Model):
    ...
    name = models.CharField(max_length=30,verbose_name=u'课程名字')
